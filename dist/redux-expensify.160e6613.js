...
},{"symbol-observable":"../node_modules/symbol-observable/es/index.js"}],"../node_modules/uuid/lib/rng-browser.js":[function(require,module,exports) {
...
var expensesReducerDefault = [];

var expensesReducer = function expensesReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : expensesReducerDefault;
  var action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case 'ADD_EXPENSE':
      return _toConsumableArray(state).concat([action.expense]);
...
store.subscribe(function () {
  ...
  var visbileExpenses = getVisibleExpenses(state.expenses, state.filters);
