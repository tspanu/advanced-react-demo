...
function (_React$Component) {
  ...
  function IndecisisionApp(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(IndecisisionApp).call(this, props));
  ...
  _createClass(IndecisisionApp, [{
    ...
    value: function render() {
      ...
      }), _react.default.createElement(AddOption, {
...
var Options = function Options(props) {
  ...
  }, "Remove All"), props.options.length === 0 && _react.default.createElement("p", null, "Please add an option to get started"), props.options.map(function (option) {
...
_reactDom.default.render(_react.default.createElement(IndecisisionApp, null), document.getElementById('app'));
